...
(function () {
    ...
    function newContext(a) {
        function t(a) {
            ...
            for (b = 0; c = a[b]; b++)
                ...
                if (b !== 1 || a[2] !== ".." && a[0] !== "..") b > 0 && (a.splice(b - 1, 2), b -= 2);
                else break
        }

        function u(a, b) {
            var c, e;
            return a && a.charAt(0) === "." && b && (d.pkgs[b] ? b = [b] : (b = b.split("/"), b = b.slice(0, b.length - 1)), a = b.concat(a.split("/")), t(a), e = d.pkgs[c = a[0]], a = a.join("/"), e && a === c + "/" + e.main && (a = c)), a
        }
        ...
        function v(a, c) {
            var d = a ? a.indexOf("!") : -1,
                ...
                i = a,
                j, k, l;
            return d !== -1 && (e = a.substring(0, d), a = a.substring(d + 1, a.length)), e && (e = u(e, f)), a && (e ? (l = h[e], l && l.normalize ? j = l.normalize(a, function (a) {
                return u(a, f)
            }) : j = u(a, f)) : (j = u(a, f), k = g[j], k || (k = b.nameToUrl(j, null, c), g[j] = k))), {
                prefix: e,
                name: j,
                parentMap: c,
                url: k,
        ...
        function A(a) {
            ...
            if (j && isFunction(j)) {
                if (d.catchError.define) try {
                    e = req.execCb(n, a.callback, p, h[n])
                } catch (t) {
                    f = t
                } else e = req.execCb(n, a.callback, p, h[n]);
                n && (a.cjsModule && a.cjsModule.exports !== undefined ? e = h[n] = a.cjsModule.exports : e === undefined && a.usingExports ? e = h[n] : (h[n] = e, q[n] && (r[n] = !0)))
            } else n && (e = h[n] = j, q[n] && (r[n] = !0));
            k[a.id] && (delete k[a.id], a.isDone = !0, b.waitCount -= 1, b.waitCount === 0 && (l = [])), delete o[n], req.onResourceLoad && !a.placeholder && req.onResourceLoad(b, m, a.depArray);
            if (f) return g = (n ? v(n).url : "") || f.fileName || f.sourceURL, i = f.moduleTree, f = makeError("defineerror", 'Error evaluating module "' + n + '" at location "' + g + '":\n' + f + "\nfileName:" + g + "\nlineNumber: " + (f.lineNumber || f.line), f), f.moduleName = n, f.moduleTree = i, req.onError(f);
            for (c = 0; j = s[c]; c++) j(e);
            return undefined
        }
        ...
        function B(a, b) {
            return function (c) {
                a.depDone[b] || (a.depDone[b] = !0, a.deps[b] = c, a.depCount -= 1, a.depCount || A(a))
            }
        }
        ...
        function C(a, e) {
            ...
            e.loading = !0, l = function (a) {
                ...
                j[a] = !1, b.scriptCount += 1, b.fake[a] = !0, d && (useInteractive = !1), req.exec(c), d && (useInteractive = !0), b.completeLoad(a)
            }, g in h ? l(h[g]) : k.load(i, y(f.parentMap, !0), l, d)
        }

        function D(a) {
            k[a.id] || (k[a.id] = a, l.push(a), b.waitCount += 1)
        }
        ...
        function F(a, b) {
            var c = a.fullName,
                d = a.prefix,
                e = d ? p[d] || (p[d] = h[d]) : null,
                g, i, k;
            return c && (g = o[c]), g || (i = !0, g = {
                id: (d && !e ? n+++"__p@:" : "") + (c || "__r@" + n++),
                map: a,
                depCount: 0,
                depDone: [],
                depCallbacks: [],
                ...
                listeners: [],
                add: E
            }, f[g.id] = !0, c && (!d || p[d]) && (o[c] = g)), d && !e ? (k = F(v(d), !0), k.add(function (b) {
        ...
        function G(a, c, e, g) {
            var i = v(a, g),
                ...
                t, u, w, x, z;
            if (n) {
                if (n in h || j[p] === !0 || n === "jquery" && d.jQuery && d.jQuery !== e().fn.jquery) return;
                f[p] = !0, j[p] = !0, n === "jquery" && e && jQueryCheck(e())
            }
            o.depArray = c, o.callback = e;
            for (t = 0; t < c.length; t++) u = c[t], u && (u = v(u, l ? i : g), w = u.fullName, x = u.prefix, c[t] = w, w === "require" ? s[t] = y(i) : w === "exports" ? (s[t] = h[n] = {}, o.usingExports = !0) : w === "module" ? o.cjsModule = z = s[t] = {
                id: l,
                uri: l ? b.nameToUrl(l, null, g) : undefined,
                exports: h[n]
            } : !(w in h) || w in k || n in q && !(n in q && r[w]) ? (n in q && (q[w] = !0, delete h[w], m[u.url] = !1), o.depCount += 1, o.depCallbacks[t] = B(o, t), F(u, !0).add(o.depCallbacks[t])) : s[t] = h[w]);
            o.depCount ? D(o) : A(o)
        }
        ...
        function I(a, b) {
            ...
            if (d)
                for (e = 0; e < d.length; e++) f = d[e], f && (i = v(f).prefix, i && (l = k[i]) && I(l, b), g = k[f], g && !g.isDone && j[f] && (m = I(g, b), a.depCallbacks[e](m)));
        ...
        function J() {
            ...
            if (e && f) return m = makeError("timeout", "Load timeout for modules: " + f), m.requireType = "timeout", m.requireModules = f, req.onError(m);
            if (h || b.scriptCount) return (isBrowser || isWebWorker) && !checkLoadedTimeoutId && (checkLoadedTimeoutId = setTimeout(function () {
        ...
        return jQueryCheck = function (a) {
            if (!b.jQuery) {
                ...
                if (c) {
                    ...
                    if ("holdReady" in c || "readyWait" in c) b.jQuery = c, H(["jquery", [],
                        function () {
                            return jQuery
                        }
            ...
            var a, c, f, g, h, i, k;
            s += 1, b.scriptCount <= 0 && (b.scriptCount = 0);
            while (e.length) {
                i = e.shift();
                if (i[0] === null) return req.onError(makeError("mismatch", "Mismatched anonymous define() module: " + i[i.length - 1]));
                H(i)
            }
            if (!d.priorityWait || w())
                while (b.paused.length) {
                    h = b.paused, b.pausedCount += h.length, b.paused = [];
                    for (g = 0; a = h[g]; g++) c = a.map, f = c.url, k = c.fullName, c.prefix ? C(c.prefix, a) : !m[f] && !j[k] && (req.load(b, k, f), m[f] = !0);
                    b.startTime = (new Date).getTime(), b.pausedCount -= h.length
                }
            return s === 1 && J(), s -= 1, undefined
        }, b = {
            contextName: a,
            config: d,
            defQueue: e,
            ...
            configure: function (a) {
                ...
                a.priority && (j = b.requireWait, b.requireWait = !1, b.takeGlobalQueue(), c(), b.require(a.priority), c(), b.requireWait = j, d.priorityWait = a.priority), (a.deps || a.callback) && b.require(a.deps || [], a.callback)
            },
            ...
            require: function (d, e, f) {
                var g, i, j;
                if (typeof d == "string") return isFunction(e) ? req.onError(makeError("requireargs", "Invalid require call")) : req.get ? req.get(b, d, e) : (g = d, f = e, j = v(g, f), i = j.fullName, i in h ? h[i] : req.onError(makeError("notloaded", "Module name '" + j.fullName + "' has not been loaded yet for context: " + a)));
                (d && d.length || e) && G(null, d, e, f);
                if (!b.requireWait)
                    while (!b.scriptCount && b.paused.length) b.takeGlobalQueue(), c();
                return b.require
            },
            ...
            completeLoad: function (a) {
                ...
                d ? H(d) : H([a, [], a === "jquery" && typeof jQuery != "undefined" ? function () {
                    return jQuery
                } : null]), jQueryCheck(), req.isAsync && (b.scriptCount -= 1), c(), req.isAsync || (b.scriptCount -= 1)
            },
            toUrl: function (a, c) {
                var d = a.lastIndexOf("."),
                    e = null;
    ...
    var version = "1.0.1",
        ...
        checkLoadedDepth = 0,
        useInteractive = !1,
        req, cfg = {}, currentlyAddingScript, s, head, baseElement, scripts, script, src, subPath, mainScript, dataMain, i, ctx, jQueryCheck, checkLoadedTimeoutId;
    ...
    typeof require != "undefined" && !isFunction(require) && (cfg = require, require = undefined), req = requirejs = function (a, b) {
        ...
        var g;
        return isBrowser ? (d = d || req.onScriptLoad, g = b && b.config && b.config.xhtml ? document.createElementNS("http://www.w3.org/1999/xhtml", "html:script") : document.createElement("script"), g.type = e || "text/javascript", g.charset = "utf-8", g.async = !s.skipAsync[a], b && g.setAttribute("data-requirecontext", b.contextName), g.setAttribute("data-requiremodule", c), g.attachEvent && !isOpera ? (useInteractive = !0, f ? g.onreadystatechange = function (a) {
...
function () {
...
}(), define("text!workshop/contents.json", [], function () {
    return '{\n\n  "toolbox": [\n\n    {\n      "name": "two.js",\n      "thumb": "img/thumbs/two.jpg",\n      "filestring": "Two",\n      "example": "http://jonobr1.github.com/two.js",\n      "source": "http://github.com/jonobr1/two.js/",\n      "min": "https://raw.github.com/jonobr1/two.js/master/build/two.min.js",\n      "minSize": "62kb",\n      "max": "https://raw.github.com/jonobr1/two.js/master/build/two.js",\n      "maxSize": "147kb",\n      "description": "A two-dimensional drawing API geared towards modern web browsers. It is renderer agnostic enabling the same api to draw in multiple contexts: SVG, Canvas, and WebGL.",\n      "greenButton": "Read the Tutorial"\n    },\n\n    {\n      "name": "Tailbone",\n      "thumb": "img/thumbs/tailbone.jpg",\n      "filestring": "tailbone",\n      "example": "examples/tailbone/",\n      "source": "https://github.com/dataarts/tailbone",\n      "max": "http://github.com/dataarts/tailbone/zipball/master",\n      "maxSize": "69kb",\n      "description": "Tailbone is an open source project that allows developers to use Google App Engine without writing server-side code.",\n      "greenButton": "Read the Tutorial"\n    },\n\n    {\n      "name": "dat.GUI",\n      "thumb": "img/thumbs/datgui.png",\n      "filestring": "dat.gui",\n      "example": "examples/gui/",\n      "source": "https://github.com/dataarts/dat.gui",\n      "min": "https://raw.github.com/dataarts/dat.gui/master/build/dat.gui.min.js",\n      "minSize": "45kb",\n      "max": "https://raw.github.com/dataarts/dat.gui/master/build/dat.gui.js",\n      "maxSize": "98kb",\n      "description": "A lightweight graphical user interface for changing variables in JavaScript. Rather than modify variables manually in your code, use dat.GUI to modify them during execution.",\n      "greenButton": "Read the Tutorial"\n    },\n    {\n      "name": "three.js",\n      "thumb": "img/thumbs/three.png",\n      "filestring": "Three",\n      "example": "http://mrdoob.github.com/three.js/",\n      "source": "http://github.com/mrdoob/three.js/",\n      "max": "http://github.com/mrdoob/three.js/zipball/master",\n      "maxSize": "54.8mb",\n      "description": "A lightweight 3D engine. Three.js makes it easy to render graphics with canvas, svg, and WebGL. The project is led by one of our team members, Mr.doob.",\n      "greenButton": "See Examples"\n    },\n    {\n      "name": "stats.js",\n      "thumb": "img/thumbs/stats.png",\n      "filestring": "stats",\n      "example": "http://github.com/mrdoob/stats.js#readme",\n      "source": "http://github.com/mrdoob/stats.js",\n      "min": "https://raw.github.com/mrdoob/stats.js/master/build/Stats.js",\n      "minSize": "2.67kb",\n      "max": "https://raw.github.com/mrdoob/stats.js/master/src/Stats.js",\n      "maxSize": "4.71kb",\n      "description": "A JavaScript performance widget. Stats.js adds a simple info box to your page displaying frames per second (FPS) or, with a mouse click, the milliseconds required to render the frame. Led by Mr.doob.",\n      "greenButton": "View README"\n    }\n\n  ],\n\n  "projects": [\n\n    {\n      "name": "Just A Reflektor",\n      "thumb": "img/thumbs/reflektor.png",\n      "url": "http://www.chromeexperiments.com/detail/just-a-reflektor/"\n    },\n    {\n      "name": "Google Hot Trends",\n      "thumb": "img/thumbs/trends.png",\n      "url": "http://www.google.com/trends/hottrends/visualize?pn=p1"\n    },\n    {\n      "name": "Cube Slam",\n      "thumb": "img/thumbs/cubeslam.png",\n      "url": "http://www.chromeexperiments.com/detail/cube-slam/"\n    },\n    {\n      "name": "The Peanut Gallery",\n      "thumb": "img/thumbs/peanut.png",\n      "url": "http://www.chromeexperiments.com/detail/peanut-gallery/"\n    },\n    {\n      "name": "100,000 Stars",\n      "thumb": "img/thumbs/stars.png",\n      "url": "http://www.chromeexperiments.com/detail/100000-stars/"\n    },\n    {\n      "name": "This Exquisite Forest",\n      "thumb": "img/thumbs/tef.png",\n      "url": "http://www.chromeexperiments.com/detail/this-exquisite-forest/"\n    },\n    {\n      "name": "Generative Machines",\n      "thumb": "img/thumbs/machines.png",\n      "url": "http://www.chromeexperiments.com/detail/generative-machines/"\n    },\n    {\n      "name": "3 Dreams of Black",\n      "thumb": "img/thumbs/rome.png",\n      "url": "http://www.chromeexperiments.com/detail/3-dreams-of-black/"\n    },\n    {\n      "name": "WebGL Globe",\n      "thumb": "img/thumbs/globe.png",\n      "url": "http://www.chromeexperiments.com/globe"\n    },\n    {\n      "name": "Cloud Globe",\n      "thumb": "img/thumbs/cloud.png",\n      "url": "http://www.chromeexperiments.com/detail/cloud-globe/"\n    },\n    {\n      "name": "Arms Globe",\n      "thumb": "img/thumbs/arms.png",\n      "url": "http://www.chromeexperiments.com/detail/arms-globe/"\n    },\n    {\n      "name": "Chrome Experiment #500",\n      "thumb": "img/thumbs/500.png",\n      "url": "http://www.chromeexperiments.com/detail/experiment-500/"\n    },\n    {\n      "name": "WebGL Bookcase",\n      "thumb": "img/thumbs/bookcase.png",\n      "url": "http://www.chromeexperiments.com/detail/webgl-bookcase/"\n    },\n    {\n      "name": "The Wilderness Downtown",\n      "thumb": "img/thumbs/wilderness3.png",\n      "url": "http://www.chromeexperiments.com/arcadefire/"\n    }\n\n  ]\n\n}'
}), define("text!workshop/template.tool.html", [], function () {
...
}), define("text!workshop/template.project.html", [], function () {
    ...
    function j() {
        var a = d,
            c = e;
        b && (a.length && (d = [], i(a)), f.resourcesDone && c.length && (e = [], i(c)))
    }

    function k() {
        b || (b = !0, h && clearInterval(h), j())
    }

    function l(a) {
        return b ? a(c) : d.push(a), l
    }
    var a = typeof window != "undefined" && window.document,
        b = !a,
        c = a ? document : null,
        d = [],
        e = [],
        f = requirejs || require || {}, g = f.resourcesReady,
        h;
    return "resourcesReady" in f && (f.resourcesReady = function (a) {
        g && g(a), a && j()
    }), a && (document.addEventListener ? (document.addEventListener("DOMContentLoaded", k, !1), window.addEventListener("load", k, !1)) : window.attachEvent && (window.attachEvent("onload", k), self === self.top && (h = setInterval(function () {
        try {
            document.body && (document.documentElement.doScroll("left"), k())
        } catch (a) {}
    }, 30))), document.readyState === "complete" && k()), l.withResources = function (a) {
        return b && f.resourcesDone ? a(c) : e.push(a), l
    }, l.version = "1.0.0", l.load = function (a, b, c, d) {
    ...
    function b(a, b) {
        var c = a || 362436069,
            d = b || 521288629,
            e = function () {
                return c = 36969 * (c & 65535) + (c >>> 16) & 4294967295, d = 18e3 * (d & 65535) + (d >>> 16) & 4294967295, ((c & 65535) << 16 | d & 65535) & 4294967295
            };
    ...
    function c(a) {
        function h(a, b, c, d) {
            var e = a & 15,
                f = e < 8 ? b : c,
                g = e < 4 ? c : e === 12 || e === 14 ? b : d;
            return ((e & 1) === 0 ? f : -f) + ((e & 2) === 0 ? g : -g)
        }

        function j(a, b, c) {
            return i = (a & 1) == 0 ? b : c, (a & 2) == 0 ? -i : i
        }
        ...
        var c = a !== undefined ? new b(a) : b.createRandomized(),
            d, e, f = new Array(512);
        ...
        this.noise3d = function (a, b, c) {
            ...
            var i = (3 - 2 * a) * a * a,
                ...
                q = f[p] + g,
                r = f[p + 1] + g;
            return l(k, l(j, l(i, h(f[n], a, b, c), h(f[q], a - 1, b, c)), l(i, h(f[o], a, b - 1, c), h(f[r], a - 1, b - 1, c))), l(j, l(i, h(f[n + 1], a, b, c - 1), h(f[q + 1], a - 1, b, c - 1)), l(i, h(f[o + 1], a, b - 1, c - 1), h(f[r + 1], a - 1, b - 1, c - 1))))
        };
        var m, n, o, p, q, r, s, t;
        this.noise2d = function (a, b) {
            return s = Math.floor(a), t = Math.floor(b), m = s & 255, n = t & 255, a -= s, b -= t, o = (3 - 2 * a) * a * a, r = (3 - 2 * b) * b * b, p = f[m] + n, q = f[m + 1] + n, l(r, l(o, j(f[p], a, b), j(f[q], a - 1, b)), l(o, j(f[p + 1], a, b - 1), j(f[q + 1], a - 1, b - 1)))
        }, this.noise1d = function (a) {
            var b = Math.floor(a) & 255;
            a -= Math.floor(a);
            var c = (3 - 2 * a) * a * a;
            return l(c, k(f[b], a), k(f[b + 1], a - 1))
        }
    }
    var a = function () {
        function c(a) {
        ...
        for (var b = 0; b < 256; b++) a[256 + b] = a[b];
        return {
            noise: function (b, f, g) {
                ...
                var n = b - 1,
                    ...
                    y = a[x] + m,
                    z = a[x + 1] + m;
                return d(t, d(s, d(r, e(a[v], b, f, g), e(a[y], n, f, g)), d(r, e(a[w], b, o, g), e(a[z], n, o, g))), d(s, d(r, e(a[v + 1], b, f, q), e(a[y + 1], n, f, g - 1)), d(r, e(a[w + 1], b, o, q), e(a[z + 1], n, o, q))))
            }
        }
    };
    b.createRandomized = function () {
        var a = new Date;
        return new b(a / 6e4 & 4294967295, a & 4294967295)
    };
    var d = {
        generator: undefined,
        octaves: 1,
    ...
    var a;
    typeof Float32Array != "undefined" ? a = Float32Array : a = Array;
    var b, c;
    return function (d) {
        d = d || {}, c = {};
        ...
        return Object.defineProperties(a.prototype, c), a
    }
}), define("workshop/FizzyText", ["workshop/improvedNoise", "dat/types/ExtendableFloatArray"], function (a, b) {
    function f() {
        var a = new e(5);
        return a[0] = 0, a[1] = 0, a[2] = 0, a[3] = 0, a[4] = 0, a
    }
    var c = 2 * Math.PI,
        d, e = b({
            x: 0,
    ...
    e.prototype.render = function (a) {
        a.beginPath(), a.arc(this[0], this[1], this[2], 0, c, !1), a.fill()
    }, e.prototype.update = function (b) {
        d = a(this[0] / b.noiseScale, this[1] / b.noiseScale) * b.noiseStrength, b.getColor(this[0], this[1]) > 0 ? this[2] += b.growthSpeed : this[2] -= b.growthSpeed, this[3] *= .8, this[4] *= .8, this[0] += Math.cos(d) * b.speed + this[3], this[1] -= Math.sin(d) * b.speed + this[4];
        if (this[2] > b.maxSize) this[2] = b.maxSize;
        else if (this[2] < 0) return this[2] = 0, this[0] = Math.random() * b.width, this[1] = b.height2 + (Math.random() * 2 - 1) * b.fontSize2, !1;
        return !0
    };
    var g = function (a, b, d, e, g) {
        this.growthSpeed = .37, this.maxSize = 8, this.noiseStrength = 10, this.speed = .4, this.displayOutline = !1, this.framesRendered = 0, Object.defineProperty(this, "message", {
            get: function () {
                return a
            },
            set: function (b) {
            ...
            for (var b in q) {
                var d = Math.random() * c;
                q[b][3] = Math.cos(d) * a, q[b][4] = Math.sin(d) * a
            }
        };
        var h = this,
            i = b,
        ...
        this.color0 = "#00aeff", this.color1 = "#0fa954", this.color2 = "#54396e", this.color3 = "#e61d5f";
        var l = document.createElement("canvas"),
            m = l.getContext("2d"),
            n = this.domElement = document.createElement("canvas"),
            o = n.getContext("2d");
        this.domElement.width = this.width = l.width = i, this.domElement.height = this.height = l.height = j;
        var p = [],
            q = [],
            r = e ? "darker" : "lighter";
        m.font = o.font = "bold " + g + "px Helvetica, Arial, sans-serif", o.globalCompositeOperation = r;
        for (var s = 0; s < 1200; s++) q.push(f());
        var t = function (a) {
            m.clearRect(0, 0, i, j), m.fillStyle = "#f00", m.textAlign = o.textAlign = "center", m.textBaseline = o.textBaseline = "middle", m.fillText(a, i / 2, j / 2);
        ...
        this.render = function () {
            h.framesRendered++, o.clearRect(0, 0, i, j), h.displayOutline && (o.globalCompositeOperation = "source-over", o.strokeStyle = e ? "#000" : "#fff", o.lineWidth = 2, o.strokeText(a, i / 2, j / 2), o.globalCompositeOperation = r);
            for (var b = 0; b < w; b++) {
                o.fillStyle = this["color" + b], x = y * b;
                for (v = 0; v < y; v++) u = q[v + x], u.update(this) && u.render(o)
            }
    ...
    link: function (a, b) {
        ...
        c.type = "text/css", c.rel = "stylesheet", c.setAttribute("href", a);
        ...
        function (a) {
            document.styleSheets.length != a ? e() : setTimeout(arguments.callee, 20)
        }(document.styleSheets.length), d.appendChild(c), c
    },
    inject: function (a, b) {
        b = b || document;
    ...
    return {
        ...
        rgb_to_hsv: function (a, b, c) {
            ...
            return a == e ? g = (b - c) / f : b == e ? g = 2 + (c - a) / f : g = 4 + (a - b) / f, g /= 6, g < 0 && (g += 1), {
                h: g * 360,
                s: h,
                v: e / 255
            }
        ...
        rgb_to_hex: function (a, b, c) {
            ...
            return d = this.hex_with_component(d, 1, b), d = this.hex_with_component(d, 0, c), d
        },
    ...
    return {
        ...
        compose: function () {
            ...
            return function () {
                ...
                for (var d = a.length - 1; d >= 0; d--) c = [a[d].apply(this, c)];
                return c[0]
            }
        },
        each: function (b, c, d) {
    ...
    var c, d, e = function () {
            ...
            return b.each(f, function (e) {
                if (e.litmus(a)) return b.each(e.conversions, function (e, f) {
                    c = e.read(a);
                    if (d === !1 && c !== !1) return d = c, c.conversionName = f, c.conversion = e, b.BREAK
                }), b.BREAK
            }), d
        }, f = [{
            litmus: b.isString,
            ...
            conversions: {
                RGB_ARRAY: {
                    ...
                    write: function (a, b) {
                        return b[0] = a.r, b[1] = a.g, b[2] = a.b, [a.r, a.g, a.b]
                    }
                },
                RGBA_ARRAY: {
                    read: function (a) {
                    ...
                    write: function (a, b) {
                        return b[0] = a.r, b[1] = a.g, b[2] = a.b, b[3] = a.a, [a.r, a.g, a.b, a.a]
                    }
                }
            }
        }, {
            ...
            conversions: {
                RGBA_OBJ: {
                    ...
                    write: function (a, b) {
                        return b.r = a.r, b.g = a.g, b.b = a.b, b.a = a.a, {
                            r: a.r,
                            g: a.g,
                            b: a.b,
                            a: a.a
...
function () {
    var a = "text",
        b = "dat/utils/css",
        c = {};
    define("dat/require/css", [b, a], function (a, d) {
        return {
            ...
            write: function (a, e, f) {
                if (e in c) {
                    ...
                    f.asModule(a + "!" + e, "define(['" + b + "'], function(css) {" + "return css.inject('" + g + "');});\n")
                }
            }
        }
    })
}(), define("dat/require/css!dat/gui/gui.css", ["dat/utils/css"], function (a) {
    ...
    function g(b) {
        if (b === "0" || a.isUndefined(b)) return 0;
        var c = b.match(f);
    ...
    var f = /(-?\d+(\.\d+)?)px/,
        h = {
            makeSelectable: function (a, b) {
                if (a === undefined || a.style === undefined) return;
                a.onselectstart = b ? function () {
                    return !1
                } : function () {};
                var c = b ? "auto" : "none";
                return a.style.MozUserSelect = c, a.style.KhtmlUserSelect = c, a.style.webkitUserSelect = c, a.style.msUserSelect = c, a.unselectable = b ? "on" : "off", h
            },
            makeFullscreen: function (b, c, d) {
                return a.isUndefined(c) && (c = !0), a.isUndefined(d) && (d = !0), b.style.position = "absolute", c && (b.style.left = 0, b.style.right = 0), d && (b.style.top = 0, b.style.bottom = 0), h
            },
            fakeEvent: function (b, c, d, f) {
                ...
                case "MouseEvents":
                    var i = d.x || d.clientX || 0,
                        j = d.y || d.clientY || 0;
                    h.initMouseEvent(c, d.bubbles || !1, d.cancelable || !0, window, d.clickCount || 1, 0, 0, i, j, !1, !1, !1, !1, 0, null);
                    break;
                case "KeyboardEvents":
                    ...
                    a.defaults(d, {
                        ...
                        keyCode: undefined,
                        charCode: undefined
                    }), k(c, d.bubbles || !1, d.cancelable, window, d.ctrlKey, d.altKey, d.shiftKey, d.metaKey, d.keyCode, d.charCode);
                    break;
                default:
                    h.initEvent(c, d.bubbles || !1, d.cancelable || !0)
                }
                ...
                if (b in c) {
                    ...
                    b = c[b], e = function (a) {
                        var b = a.relatedTarget,
                            c = this;
                        (!b || b !== c && !h.contains(c, b)) && g.call(this, a)
                    }, d[g] = e
                }
                return a.addEventListener ? a.addEventListener(b, e, !! f) : a.attachEvent && a.attachEvent("on" + b, e), h
            },
            makeBinding: function () {
                var b = a.toArray(arguments);
                return {
                    unbind: function () {
                        return h.unbind.apply(this, b), this
                    },
                    bind: function () {
                        return h.bind.apply(this, b), this
                    },
                    addTo: function (a) {
            ...
            unbind: function (b, e, f, g) {
                ...
                if (e in c) {
                    e = c[e];
                    var i = d[f];
                    a.isFunction(i) && (f = i, delete d[f])
                }
                return b.removeEventListener ? b.removeEventListener(e, f, !! g) : b.detachEvent && b.detachEvent("on" + e, f), h
            },
            addClass: function (a, b) {
                if (a.className === undefined) a.className = b;
                else if (a.className !== b) {
                    var c = a.className.split(/ +/);
                    c.indexOf(b) == -1 && (c.push(b), a.className = c.join(" ").replace(/^\s+/, "").replace(/\s+$/, ""))
                }
                return h
            },
            ...
            getWidth: function (a) {
                if (a === window) return "innerWidth" in window ? window.innerWidth : document.documentElement.offsetWidth;
                if (a === document) return Math.max(document.documentElement.clientWidth, document.body.scrollWidth, document.documentElement.scrollWidth, document.body.offsetWidth, document.documentElement.offsetWidth);
                var b = getComputedStyle(a);
                return g(b["border-left-width"] || b.borderLeftWidth) + g(b["border-right-width"] || b.borderRightWidth) + g(b["padding-left"] || b.paddingLeft) + g(b["padding-right"] || b.paddingRight) + g(b.width)
            },
            getHeight: function (a) {
                if (a === window) return "innerHeight" in window ? window.innerHeight : document.documentElement.offsetHeight;
                if (a === document) return Math.max(document.documentElement.clientHeight, document.body.scrollHeight, document.documentElement.scrollHeight, document.body.offsetHeight, document.documentElement.offsetHeight);
                var b = getComputedStyle(a);
                return g(b["border-top-width"] || b.borderTopWidth) + g(b["border-bottom-width"] || b.borderBottomWidth) + g(b["padding-top"] || b.paddingTop) + g(b["padding-bottom"] || b.paddingBottom) + g(b.height)
            },
    ...
    return h
}), define("dat/controllers/Controller", ["dat/utils/common", "dat/dom/dom"], function (a, b) {
    var c = function (a, b) {
        this.initialValue = a[b], this.domElement = document.createElement("div"), this.object = a, this.property = b, this.__onChange = undefined, this.__onFinishChange = undefined
    };
    return a.extend(c.prototype, {
        ...
        setValue: function (a, b) {
            return b || (this.object[this.property] = a), this.__onChange && this.__onChange.call(this, a), this.updateDisplay(), this
        },
        getValue: function () {
    ...
    var c = function (a, e, f) {
        c.superclass.call(this, a, e), f = f || {}, this.__min = f.min, this.__max = f.max, this.__step = f.step, b.isUndefined(this.__step) ? this.initialValue == 0 ? this.__impliedStep = 1 : this.__impliedStep = Math.pow(10, Math.floor(Math.log(this.initialValue) / Math.LN10)) / 10 : this.__impliedStep = this.__step, this.__precision = d(this.__impliedStep)
    };
    return c.superclass = a, b.extend(c.prototype, a.prototype, {
        setValue: function (a) {
            return this.__min !== undefined && a < this.__min ? a = this.__min : this.__max !== undefined && a > this.__max && (a = this.__max), this.__step !== undefined && a % this.__step != 0 && (a = Math.round(a / this.__step) * this.__step), c.superclass.prototype.setValue.call(this, a)
        },
        min: function (a) {
        ...
        step: function (a) {
            return this.__step = this.__impliedStep = a, this
        }
    }), c
    ...
    var d = function (a, c, e) {
        d.superclass.call(this, a, c);
        var f = this;
        this.__button = document.createElement("div"), this.__button.innerHTML = e === undefined ? "Fire" : e, b.bind(this.__button, "click", function (a) {
    ...
    var d = function (a, e, f) {
        ...
        this.__input = document.createElement("input"), this.__input.setAttribute("type", "text"), b.bind(this.__input, "change", i), b.bind(this.__input, "blur", j), b.bind(this.__input, "mousedown", k), b.bind(this.__input, "keydown", function (a) {
            a.keyCode === 13 && (g.__truncationSuspended = !0, j(), g.__truncationSuspended = !1)
        }), this.updateDisplay(), this.domElement.appendChild(this.__input)
    };
    return d.superclass = a, c.extend(d.prototype, a.prototype, {
        updateDisplay: function () {
    ...
    var f = function (a, c, d, e, h, i, j) {
        function l(a) {
            b.bind(window, "mousemove", m), b.bind(window, "mouseup", n), m(a)
        }
        ...
        function m(a) {
            ...
            k.__normalized = g(a.clientX, c.left, c.left + d, 0, 1);
            var e = k.__curve(k.__normalized);
            return k.setValue(g(e, 0, 1, k.__min, k.__max)), !1
        }

        function n() {
            b.unbind(window, "mousemove", m), b.unbind(window, "mouseup", n), k.__onFinishChange && k.__onFinishChange.call(k, k.getValue())
        }
        ...
        var k = this;
        this.__background = document.createElement("div"), this.__foreground = document.createElement("div"), this.__curve = i || function (a) {
            return a
        }, this.__invCurve = j || function (a) {
            return a
        }, b.bind(this.__background, "mousedown", l), b.addClass(this.__background, "slider"), b.addClass(this.__foreground, "slider-fg"), this.updateDisplay(), this.__background.appendChild(this.__foreground), this.domElement.appendChild(this.__background)
    };
    return f.superclass = a, f.useDefaultStyles = function () {
        ...
        updateDisplay: function () {
            ...
            return this.__foreground.style.width = this.__invCurve(a) * 100 + "%", f.superclass.prototype.updateDisplay.call(this)
        },
        curve: function (a, b) {
            return this.__curve = a, this.__invCurve = b, this
        }
    }), f
    ...
    return function (h, i) {
        var j = h[i];
        if (g.isArray(arguments[2]) || g.isObject(arguments[2])) return new a(h, i, arguments[2]);
        if (g.isNumber(j)) return g.isNumber(arguments[2]) && g.isNumber(arguments[3]) ? new c(h, i, arguments[2], arguments[3], arguments[4], arguments[5], arguments[6]) : new b(h, i, {
            min: arguments[2],
            max: arguments[3]
        });
        if (g.isString(j)) return new d(h, i);
        if (g.isFunction(j)) return new e(h, i, "");
        if (g.isBoolean(j)) return new f(h, i)
    }
}), define("dat/controllers/TinkerController", ["dat/controllers/Controller", "dat/dom/dom", "dat/utils/common"], function (Controller, dom, common) {
    var TinkerController = function (object, property, text) {
        TinkerController.superclass.call(this, object, property);
        var _this = this;
        this.__textarea = document.createElement("textarea"), this.__textarea.innerHTML = this.getValue(), dom.bind(this.__textarea, "keyup", function (e) {
            var fnc;
            try {
                fnc = eval("(" + this.value + ")"), _this.setValue(fnc)
            } catch (e) {
                throw e
            }
        }), this.domElement.appendChild(this.__textarea)
    };
    return TinkerController.superclass = Controller, common.extend(TinkerController.prototype, Controller.prototype, {}), TinkerController
    ...
    var a = {
        ...
        cmap: function (b, c, d, e, f) {
            return a.clamp(e + (f - e) * (b - c) / (d - c), e, f)
        },
        wrap: function (a, b) {
            while (a < 0) a += b;
            return a % b
        ...
        cap: function (b, c) {
            return Math.abs(b) > c ? a.sign(b) * c : b
        },
        ...
        random: function () {
            ...
            if (arguments.length == 1) {
                if (typeof arguments[0] == "number") return random() * arguments[0];
        ...
        bezier: function (a, b, c, d, e) {
            var f = 1 - e;
            return a * f * f * f + 3 * b * e * f * f + 3 * c * e * e * f + d * e * e * e
        },
        commaify: function (a, b) {
            b || (b = 3);
            var a = a.toString().split("").reverse().join(""),
                c = "",
                d = 0;
        ...
        makeUnselectable: function (a) {
            ...
            a.onselectstart = function () {
                return !1
            }, a.style.MozUserSelect = "none", a.style.KhtmlUserSelect = "none", a.unselectable = "on";
            var b = a.childNodes,
                c = b.length;
            for (var d = 0; d < c; d++) this.makeUnselectable(b[d])
        },
        makeSelectable: function (a) {
            if (a == undefined || a.style == undefined) return;
            a.onselectstart = function () {}, a.style.MozUserSelect = "auto", a.style.KhtmlUserSelect = "auto", a.unselectable = "off";
            var b = a.childNodes,
                c = b.length;
            for (var d = 0; d < c; d++) this.makeSelectable(b[d])
        },
        shuffle: function (a) {
    ...
    return a
}), define("dat/color/Color", ["dat/color/interpret", "dat/color/math", "dat/color/toString", "dat/utils/common", "dat/utils/utils"], function (a, b, c, d, e) {
    function g(a, b, c) {
        Object.defineProperty(a, b, {
            get: function () {
                return this.__state.space === "RGB" ? this.__state[b] : (i(this, b, c), this.__state[b])
            },
            set: function (a) {
                this.__state.space !== "RGB" && (i(this, b, c), this.__state.space = "RGB"), this.__state[b] = a
            }
        })
    }
    ...
    function h(a, b) {
        Object.defineProperty(a, b, {
            get: function () {
                return this.__state.space === "HSV" ? this.__state[b] : (j(this), this.__state[b])
            },
            set: function (a) {
                this.__state.space !== "HSV" && (j(this), this.__state.space = "HSV"), this.__state[b] = a
            }
        })
    }

    function i(a, c, e) {
        if (a.__state.space === "HEX") a.__state[c] = b.component_from_hex(a.__state.hex, e);
        else if (a.__state.space === "HSV") d.extend(a.__state, b.hsv_to_rgb(a.__state.h, a.__state.s, a.__state.v));
    ...
    return f.lerp_rgb = function (a, b, c) {
        return new f(e.lerp(a.r, b.r, c), e.lerp(a.g, b.g, c), e.lerp(a.b, b.b, c), e.lerp(a.a, b.a, c))
    ...
    }, f.lerp = f.lerp_rgb, f.inverse = function (a) {
        return new f(255 - a.r, 255 - a.g, 255 - a.b)
    }, f.mix = function (a) {
        arguments.length > 1 && (a = arguments);
        var b = 0,
            c = 0,
            d = 0,
            e = 0,
            g = a.length;
        for (var h = 0; h < g; h++) b += a[h].r, c += a[h].g, d += a[h].b, e += a[h].a;
        return b /= g, c /= g, d /= g, e /= g, new f(b, c, d, e)
    }, f.random = function () {
        return new f(Math.random() * 255, Math.random() * 255, Math.random() * 255)
    }, f.COMPONENTS = ["r", "g", "b", "h", "s", "v", "hex", "a"], d.extend(f.prototype, {
        set: function (a) {
    ...
    }), g(f.prototype, "r", 2), g(f.prototype, "g", 1), g(f.prototype, "b", 0), h(f.prototype, "h"), h(f.prototype, "s"), h(f.prototype, "v"), Object.defineProperty(f.prototype, "a", {
        get: function () {
        ...
        get: function () {
            return !this.__state.space !== "HEX" && (this.__state.hex = b.rgb_to_hex(this.r, this.g, this.b)), this.__state.hex
        },
        set: function (a) {
    ...
    function i(a, b, c, d) {
        a.style.background = "", e.each(h, function (e) {
    ...
    var f = function (a, h, k) {
        function o(a) {
            s(a), b.bind(window, "mousemove", s), b.bind(window, "mouseup", p)
        }

        function p() {
            b.unbind(window, "mousemove", s), b.unbind(window, "mouseup", p)
        }

        function q() {
            var a = d(this.value);
            a !== !1 ? (m.__color.__state = a, m.setValue(m.__color)) : this.value = m.__color.toString(), m.__onFinishChange(m.getValue())
        }

        function r() {
            b.unbind(window, "mousemove", t), b.unbind(window, "mouseup", r)
        }
        ...
        function s(a) {
            ...
            var c = b.getWidth(m.__saturation_field),
                ...
                f = (a.clientX - e.left + document.body.scrollLeft) / c,
                h = 1 - (a.clientY - e.top + document.body.scrollTop) / d;
            return h > 1 ? h = 1 : h < 0 && (h = 0), f > 1 ? f = 1 : f < 0 && (f = 0), m.__color.v = h, m.__color.s = f, g.call(m), !1
        }
        ...
        function t(a) {
            ...
            return e > 1 ? e = 1 : e < 0 && (e = 0), m.__color.h = e * 360, g.call(m), !1
        }
        f.superclass.call(this, a, h);
        var l = this.getValue();
        k = k || {}, this.__byRef = e.isObject(l) || e.isArray(l), this.__color = new c(l), this.__temp = new c(0), this.__height = k.height || 100, this.__width = k.width || 100;
        var m = this;
        ...
        }), b.bind(this.__input, "blur", q), b.bind(this.__selector, "mousedown", function (a) {
            var c = function (a) {
                b.removeClass(m.__selector, "drag"), m.__onFinishChange(m.getValue()), b.unbind(window, "mouseup", c)
            };
            b.addClass(this, "drag").bind(window, "mouseup", c)
        });
        ...
        e.extend(this.__selector.style, {
            ...
            height: "100%",
            background: "none"
        }), i(n, "top", "rgba(0,0,0,0)", "#000"), e.extend(this.__hue_field.style, {
            width: "15px",
            height: this.__height + "px",
            display: "inline-block",
            border: "1px solid #555",
            cursor: "ns-resize"
        }), j(this.__hue_field), e.extend(this.__input.style, {
            outline: "none",
            textAlign: "center",
            color: "#fff",
            border: 0,
        ...
        }), b.bind(this.__saturation_field, "mousedown", o), b.bind(this.__field_knob, "mousedown", o), b.bind(this.__hue_field, "mousedown", function (a) {
            t(a), b.bind(window, "mousemove", t), b.bind(window, "mouseup", r)
        }), this.__saturation_field.appendChild(n), this.__selector.appendChild(this.__field_knob), this.__selector.appendChild(this.__saturation_field), this.__selector.appendChild(this.__hue_field), this.__hue_field.appendChild(this.__hue_knob), this.domElement.appendChild(this.__input), this.domElement.appendChild(this.__selector), this.updateDisplay()
    };
        ...
        updateDisplay: function () {
            ...
            if (d !== !1) {
                ...
                e.each(c.COMPONENTS, function (a) {
                    if (!e.isUndefined(d[a]) && !e.isUndefined(this.__color.__state[a]) && d[a] !== this.__color.__state[a]) return f = !0, {}
                }, this), f && e.extend(this.__color.__state, d)
            }
            e.extend(this.__temp.__state, this.__color.__state), this.__temp.a = 1;
            var g = this.__color.v < .5 || this.__color.s > .5 ? 255 : 0,
                h = 255 - g,
                j = b.getHeight(this.__field_knob) / 2;
            e.extend(this.__field_knob.style, {
                marginLeft: this.__width * this.__color.s - j + "px",
                marginTop: Math.round(this.__height * (1 - this.__color.v) - j) + "px",
                backgroundColor: this.__temp.toString(),
                borderColor: "rgb(" + g + "," + g + "," + g + ")"
            }), j = b.getHeight(this.__hue_knob) / 2 + 1;
            var k = new c(this.__color.r, this.__color.g, this.__color.b);
            k.s = k.v = 1, k.h = this.__color.h, e.extend(this.__hue_knob.style, {
                backgroundColor: k.toString(),
                marginTop: Math.round(this.__height * (1 - this.__color.h / 360) - j) + "px"
            }), this.__temp.s = 1, this.__temp.v = 1, i(this.__saturation_field, "left", "#fff", this.__temp.toString()), e.extend(this.__input.style, {
...
function () {
...
}(), define("underscore", function () {}), define("dat/dom/CenteredDiv", ["dat/dom/dom", "underscore"], function (a) {
    var b = 200,
        c = b / 1e3,
        d = function (b) {
            this.backgroundElement = document.createElement("div"), _.extend(this.backgroundElement.style, {
            ...
            }), a.makeFullscreen(this.backgroundElement), this.backgroundElement.style.position = "fixed", this.domElement = document.createElement("div"), _.extend(this.domElement.style, {
                position: "fixed",
                display: "none",
                zIndex: "1001",
                opacity: 0,
                WebkitTransition: "-webkit-transform 0.2s ease-out, opacity " + c + "s linear"
            }), this.__visible = !1, document.body.appendChild(this.backgroundElement), document.body.appendChild(this.domElement);
            var d = this;
            this.permanent = !! b, a.bind(this.backgroundElement, "click", function () {
                d.permanent || d.hide()
            })
        };
    return d.prototype.show = function (a) {
        var c = this;
        return this.backgroundElement.style.display = "block", this.domElement.style.display = "block", this.domElement.style.opacity = 0, this.domElement.style.webkitTransform = "scale(1.1)", this.layout(), _.defer(function () {
        ...
        return _.delay(function () {
            c.domElement.style.display = "none", c.backgroundElement.style.display = "none", _.isFunction(a) && a.call(c)
        }, b), this.backgroundElement.style.opacity = 0, this.domElement.style.opacity = 0, this.domElement.style.webkitTransform = "scale(1.1)", this.__visible = !1, this
    }, d.prototype.layout = function () {
        this.domElement.style.left = (a.getWidth(window) - a.getWidth(this.domElement)) / 2 + "px", this.domElement.style.top = (a.getHeight(window) - a.getHeight(this.domElement)) / 2 + "px"
    }, d
}), define("dat/gui/GUI", ["text!dat/gui/saveDialogue.html", "dat/controllers/factory", "dat/controllers/Controller", "dat/controllers/BooleanController", "dat/controllers/FunctionController", "dat/controllers/NumberControllerBox", "dat/controllers/NumberControllerSlider", "dat/controllers/OptionController", "dat/controllers/ColorController", "dat/controllers/TinkerController", "dat/utils/requestAnimationFrame", "dat/dom/CenteredDiv", "dat/dom/dom", "dat/utils/common", "dat/require/css!dat/gui/gui.css"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
    function A(a, d, e, f) {
        if (d[e] === undefined) throw new Error("Object " + d + ' has no property "' + e + '"');
        var g;
        ...
        f.before instanceof c && (f.before = f.before.__li), D(a, g), m.addClass(g.domElement, "c");
        var k = document.createElement("span");
        m.addClass(k, "property-name"), k.innerHTML = g.property;
        var l = document.createElement("div");
        l.appendChild(k), l.appendChild(g.domElement);
        var n = B(a, l, f.before);
        return m.addClass(n, z.CLASS_CONTROLLER_ROW), m.addClass(n, typeof g.getValue()), f.tinker && m.addClass(n, "tinker"), C(a, n, g), a.__controllers.push(g), g
    }
    ...
    function C(a, b, c) {
        c.__li = b, c.__gui = a, n.extend(c, {
            options: function (b) {
                if (arguments.length > 1) return c.remove(), A(a, c.object, c.property, {
                    before: c.__li.nextElementSibling,
                    factoryArgs: [n.toArray(arguments)]
                });
                if (n.isArray(b) || n.isObject(b)) return c.remove(), A(a, c.object, c.property, {
                    before: c.__li.nextElementSibling,
                    factoryArgs: [b]
                })
            },
        ...
        if (c instanceof g) {
            ...
            c.attached = h, h.attached = c, n.each(f.prototype, function (a, b) {
                var d = c[b],
                    e = h[b];
                c[b] = h[b] = function () {
            ...
            }), m.addClass(b, "has-slider"), c.domElement.insertBefore(h.domElement, c.domElement.firstElementChild)
        } else if (c instanceof f) {
            var j = function (b) {
                return n.isNumber(c.__min) && n.isNumber(c.__max) ? (c.remove(), A(a, c.object, c.property, {
                    before: c.__li.nextElementSibling,
                    factoryArgs: [c.__min, c.__max, c.__step]
                })) : b
            };
            c.min = n.compose(j, c.min), c.max = n.compose(j, c.max)
        } else c instanceof d ? (m.bind(b, "click", function () {
            m.fakeEvent(c.__checkbox, "click")
        }), m.bind(c.__checkbox, "click", function (a) {
            a.stopPropagation()
        })) : c instanceof e ? (m.bind(b, "click", function () {
        ...
        })) : c instanceof i && (m.addClass(b, "color"), c.updateDisplay = n.compose(function (a) {
            return b.style.borderLeftColor = c.__color.toString(), a
        }, c.updateDisplay), c.updateDisplay());
        c.setValue = n.compose(function (b) {
            return a.getRoot().__preset_select && c.isModified() && M(a.getRoot(), !0), b
        }, c.setValue)
    }
    ...
    function D(a, b) {
        ...
        if (d != -1) {
            ...
            e === undefined && (e = {}, c.__rememberedObjectIndecesToControllers[d] = e), e[b.property] = b;
            if (c.load && c.load.remembered) {
                var f = c.load.remembered,
                    g;
                if (f[a.preset]) g = f[a.preset];
                else if (f[s]) g = f[s];
                else return; if (g[d] && g[d][b.property] !== undefined) {
                    var h = g[d][b.property];
                    b.initialValue = n.isObject(h) ? _.clone(h) : h, b.setValue(n.isObject(h) ? _.clone(h) : h)
                }
            }
        }
    }
    ...
    function F(a, b) {
        ...
        m.addClass(a.domElement, "has-save"), b || a.__ul.insertBefore(c, a.__ul.firstChild), m.addClass(c, "save-row");
        var d = document.createElement("span");
        d.innerHTML = "&nbsp;", m.addClass(d, "button gears");
        var e = document.createElement("span");
        e.innerHTML = "Save", m.addClass(e, "button"), m.addClass(e, "save");
        var f = document.createElement("span");
        f.innerHTML = "New", m.addClass(f, "button"), m.addClass(f, "save-as");
        var g = document.createElement("span");
        g.innerHTML = "Revert", m.addClass(g, "button"), m.addClass(g, "revert");
        var h = a.__preset_select = document.createElement("select");
        a.load && a.load.remembered ? n.each(a.load.remembered, function (b, c) {
            K(a, c, c == a.preset)
        ...
        if (b) return;
        c.appendChild(h), c.appendChild(d), c.appendChild(e), c.appendChild(f), c.appendChild(g);
        if (t) {
            ...
            localStorage.getItem(E(a, "isLocal")) === "true" && k.setAttribute("checked", "checked");

            function l() {
                j.style.display = a.useLocalStorage ? "block" : "none"
            }
            l(), m.bind(k, "change", function () {
                a.useLocalStorage = !a.useLocalStorage, l()
            })
        }
        var o = document.getElementById("dg-new-constructor");
        m.bind(o, "keydown", function (a) {
            a.metaKey && (a.which === 67 || a.keyCode == 67) && u.hide()
        }), m.bind(d, "click", function () {
            o.innerHTML = JSON.stringify(a.getSaveObject(), undefined, 2), u.show(), o.focus(), o.select()
    ...
    function G(a) {
        function c(c) {
            return c.preventDefault(), b = c.clientX, m.addClass(a.__closeButton, z.CLASS_DRAG), m.bind(window, "mousemove", d), m.bind(window, "mouseup", e), !1
        }
        ...
        function e() {
            m.removeClass(a.__closeButton, z.CLASS_DRAG), m.unbind(window, "mousemove", d), m.unbind(window, "mouseup", e)
        }
        a.__resize_handle = document.createElement("div"), n.extend(a.__resize_handle.style, {
            width: "6px",
            marginLeft: "-3px",
            height: "200px",
            cursor: "ew-resize",
        ...
        var b;
        m.bind(a.__resize_handle, "mousedown", c), m.bind(a.__closeButton, "mousedown", c), a.domElement.insertBefore(a.__resize_handle, a.domElement.firstElementChild)
    }
    ...
    function I(a, b) {
        var c = {};
        return n.each(a.__rememberedObjects, function (d, e) {
            var f = {}, g = a.__rememberedObjectIndecesToControllers[e];
            g || (g = {}, _.each(d, function (b, c) {
                var d = J(c, a);
                d && (g[c] = d)
            }), a.__rememberedObjectIndecesToControllers[e] = g), n.each(g, function (a, c) {
                var d = b ? a.initialValue : a.getValue();
                f[c] = n.isObject(d) ? _.clone(d) : d
            }), c[e] = f
        }), c
    }
    ...
    function J(a, b) {
        var c;
        for (var d = 0, e = b.__controllers.length; d < e; d++) {
    ...
    var p = "dg",
        ...
        z = function (a) {
            ...
            var b = this;
            this.domElement = document.createElement("div"), this.__ul = document.createElement("ul"), this.domElement.appendChild(this.__ul), m.addClass(this.domElement, p), this.__folders = {}, this.__controllers = [], this.__rememberedObjects = [], this.__rememberedObjectIndecesToControllers = [], this.__listening = [], a = a || {}, a = n.defaults(a, {
                autoPlace: !0,
                ...
                preset: s
            } : a.preset && (a.load.preset = a.preset), n.isUndefined(a.parent) && a.hideable && y.push(this), a.resizable = n.isUndefined(a.parent) && a.resizable, a.autoPlace && n.isUndefined(a.scrollable) && (a.scrollable = !0);
            var c = t && localStorage.getItem(E(this, "isLocal")) === "true";
            Object.defineProperties(this, {
                ...
                preset: {
                    ...
                    set: function (c) {
                        b.parent ? b.getRoot().preset = c : a.load.preset = c, L(this), b.revert()
                    }
                },
                width: {
                    get: function () {
                ...
                closed: {
                    ...
                    set: function (c) {
                        a.closed = c, a.closed ? m.addClass(b.__ul, z.CLASS_CLOSED) : m.removeClass(b.__ul, z.CLASS_CLOSED), this.onResize(), b.__closeButton && (b.__closeButton.innerHTML = c ? z.TEXT_OPEN : z.TEXT_CLOSED)
                    }
                },
                load: {
                    get: function () {
                ...
                useLocalStorage: {
                    ...
                    set: function (a) {
                        t && (c = a, a ? m.bind(window, "unload", h) : m.unbind(window, "unload", h), localStorage.setItem(E(b, "isLocal"), a))
                    }
                }
            });
            if (n.isUndefined(a.parent)) {
                a.closed = !1, m.addClass(this.domElement, z.CLASS_MAIN), m.makeSelectable(this.domElement, !1);
                if (t && c) {
                    b.useLocalStorage = !0;
                    var d = localStorage.getItem(E(this, "gui"));
                    d && (a.load = JSON.parse(d))
                }
                this.__closeButton = document.createElement("div"), this.__closeButton.innerHTML = z.TEXT_CLOSED, m.addClass(this.__closeButton, z.CLASS_CLOSE_BUTTON), this.domElement.appendChild(this.__closeButton), m.bind(this.__closeButton, "click", function () {
                    b.closed ? b.open() : b.close()
                })
            } else {
                a.closed === undefined && (a.closed = !0);
                var e = document.createTextNode(a.name);
                m.addClass(e, "controller-name");
                var f = B(b, e),
                    g = function (a) {
                        return a.preventDefault(), b.closed ? b.open() : b.close(), !1
                    };
                m.addClass(this.__ul, z.CLASS_CLOSED), m.addClass(f, "title"), m.bind(f, "click", g), a.closed || this.close()
            }
            a.autoPlace && (n.isUndefined(a.parent) && (v && (w = document.createElement("div"), w.style.zIndex = 1001, m.addClass(w, p), m.addClass(w, z.CLASS_AUTO_PLACE_CONTAINER), document.body.appendChild(w), v = !1), w.appendChild(this.domElement), m.addClass(this.domElement, z.CLASS_AUTO_PLACE)), this.parent || H(b, a.width)), m.bind(window, "resize", function () {
                b.onResize()
    ...
    return z.toggleHide = function () {
        ...
        hideController: function (a) {
            ...
            if (b < 0) return this;
            var c = a.__li;
            return c && (c.getAttribute("height") || c.setAttribute("height", m.getHeight(c) || 27), n.extend(c.style, {
                height: 0
            })), this
        },
        ...
        addFolder: function (a) {
            if (this.__folders[a] !== undefined) throw new Error('You already have a folder in this GUI by the name "' + a + '"');
            var b = {
                name: a,
                parent: this
            };
        ...
        onResize: function () {
            ...
            if (a.scrollable) {
                ...
                n.each(a.__ul.childNodes, function (b) {
                    if (!a.autoPlace || b !== a.__save_row) c += m.getHeight(b)
                }), window.innerHeight - b - r < c ? (m.addClass(a.domElement, z.CLASS_TOO_TALL), a.__ul.style.height = window.innerHeight - b - r + "px") : (m.removeClass(a.domElement, z.CLASS_TOO_TALL), a.__ul.style.height = "auto")
            }
        ...
        remember: function (b, c) {
            !c && n.isUndefined(u) && (u = new l, u.domElement.innerHTML = a);
            if (this.parent) throw new Error("You can only call remember on a top level GUI.");
            this.__rememberedObjects.length == 0 && F(this, !! c), this.__rememberedObjects.indexOf(b) == -1 && this.__rememberedObjects.push(b), this.autoPlace && H(this, this.width)
        },
        getRoot: function () {
            var a = this;
        ...
        getSaveObject: function () {
            var a = this.load;
            return a.closed = this.closed, this.__rememberedObjects.length > 0 && (a.preset = this.preset, a.remembered || (a.remembered = {}), a.remembered[this.preset] = I(this)), a.folders = {}, n.each(this.__folders, function (b, c) {
                a.folders[c] = b.getSaveObject()
            }), a
        },
        save: function () {
            this.load.remembered || (this.load.remembered = {}), this.load.remembered[this.preset] = I(this), M(this, !1)
        },
        saveAs: function (a) {
            this.load.remembered || (this.load.remembered = {}, this.load.remembered[s] = I(this, !0)), this.load.remembered[a] = I(this), this.preset = a, K(this, a, !0)
        },
        revert: function (a) {
            n.each(this.__controllers, function (b) {
                this.getRoot().load.remembered ? D(a || this.getRoot(), b) : b.setValue(b.initialValue)
            }, this), n.each(this.__folders, function (a) {
                a.revert(a)
            }), a || M(this.getRoot(), !1)
        },
        listen: function (a) {
            var b = this.__listening.length == 0;
            this.__listening.push(a), b && N(this.__listening)
        }
    }), z
}), define("dat/google/webfont/loader", ["underscore"], function () {
    return function (a) {
        window.WebFontConfig = window.WebFontConfig || {}, _.extend(window.WebFontConfig, a);
        var b = document.createElement("script");
        b.src = ("https:" == document.location.protocol ? "https" : "http") + "://ajax.googleapis.com/ajax/libs/webfont/1/webfont.js", b.type = "text/javascript", b.async = "true";
...
}), require(["text!workshop/contents.json", "text!workshop/template.tool.html", "text!workshop/template.project.html", "domReady", "dat/utils/requestAnimationFrame", "workshop/FizzyText", "dat/gui/GUI", "dat/dom/dom", "dat/utils/utils", "dat/google/webfont/loader", "underscore"], function (a, b, c, d, e, f, g, h, i, j) {
    function k() {
        function o() {
            e(o), d.render()
        }
        ...
        function A(b) {
            index = i.wrap(b, Math.ceil(a.projects.length / 3)), console.log(b), _.extend(q.style, {
                marginLeft: -(h.getWidth(q.parentNode) + 34) * index + "px"
            }), _.each(s, function (a, b) {
                b === index ? h.addClass(a, "active") : h.removeClass(a, "active")
            }), w = index
        }
        l();
        var d = new f("workshop", 950, 300),
            j = new g({
                autoPlace: !1,
                hideable: !0,
                resizable: !0,
        ...
        k.addColor(d, "color0").name("Color 1"), k.addColor(d, "color1").name("Color 2"), k.addColor(d, "color2").name("Color 3"), k.addColor(d, "color3").name("Color 4"), j.add(d, "message"), j.add(d, "speed", -4, 4), j.add(d, "growthSpeed", 0, 1), j.add(d, "maxSize", .1, 20), j.add(d, "displayOutline"), j.add(d, "explode").name("Explode!");
        var n = document.getElementById("mast").firstElementChild;
        n.insertBefore(d.domElement, n.firstElementChild), h.makeSelectable(document.getElementById("mast"), !1), _.extend(j.domElement.style, {
            position: "absolute",
            right: "7px",
            paddingTop: "7px",
            zIndex: 3
        }), n.insertBefore(j.domElement, n.firstElementChild), o();
        var p = document.getElementById("toolbox");
        p.innerHTML = _.template("<% _.each(toolbox, function(tool) { %>" + b + "<% }); %>", a);
        var q = document.getElementById("carousel");
        q.innerHTML = _.template("<% _.each(projects, function(project) { %>" + c + "<% }); %><br class='clear'>", a);
        var r = document.getElementById("dot-nav");
        r.innerHTML = m(a.projects);
        var s = r.getElementsByTagName("li"),
            t = q.parentNode.parentNode.getElementsByTagName("div")[2];
        h.makeSelectable(t, !1);
        var u = t.getElementsByTagName("a")[1],
            v = t.getElementsByTagName("a")[0],
            w = 0,
            x = !1,
            y = document.getElementById("about-link"),
            z = document.getElementById("about-exit");
        h.bind(u, "click", function (a) {
            a.preventDefault(), A(w + 1)
        }).bind(v, "click", function (a) {
            a.preventDefault(), A(w - 1)
        }).bind(z, "click", function (a) {
            a.preventDefault(), h.removeClass(document.body, "about"), x = !1
        }).bind(y, "click", function (a) {
            a.preventDefault(), x ? h.removeClass(document.body, "about") : h.addClass(document.body, "about"), x = !x
        }), _.each(s, function (a) {
    ...
    function m(a) {
        var b = "";
        for (var c = 0, d = Math.ceil(a.length / 3); c < d; c++) {
            var e = "";
            c === 0 && (e += 'class="active"'), b += "<li " + e + ">" + c + "</li>"
        }
        return b
    }
    j({
